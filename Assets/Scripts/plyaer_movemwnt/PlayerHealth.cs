...
/// ћы добавл€ем перегрузку TakeDamage(int damage, DamageType damageType), 
/// но обрабатываем еЄ точно так же, как обычный урон.
...
public class PlayerHealth : MonoBehaviour
{
    ...
    /// <summary>
    /// ќбычный метод получени€ урона, который уже был.
    /// </summary>
    ...
    /// <summary>
    /// Ќова€ перегрузка, принимающа€ DamageType, но обрабатывающа€ так же, как обычный урон.
    /// </summary>
    public void TakeDamage(int damage, DamageType damageType)
    {
        // ƒл€ игрока тип урона неважен Ч вызываем старый метод
        TakeDamage(damage);
    }
